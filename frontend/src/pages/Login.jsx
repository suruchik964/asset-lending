      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <label className="block text-sm font-medium text-slate-700">
          ...
          <input
            ...
            className="mt-1.5 w-full rounded-xl border border-slate-200 bg-slate-50 px-3.5 py-3 text-sm outline-none transition focus:border-indigo-500 focus:bg-white focus:ring-4 focus:ring-indigo-50"
            required
          />
        </label>
        <label className="block text-sm font-medium text-slate-700">
